...
def darknet53(input_data):
    """
    Implements the Darknet-53 feature extraction backbone used in YOLOv4.

    Args:
        input_data: TensorFlow tensor, the input tensor (e.g., an image).

    Returns:
        route_1: First route for feature map extraction (for YOLOv4 FPN).
        route_2: Second route for feature map extraction (for YOLOv4 FPN).
        input_data: Final output tensor from the Darknet-53 backbone.
    """
