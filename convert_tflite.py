...
flags.DEFINE_string(
    "quantize_mode", "float32", "quantize mode (int8, float16, float32)"
)
flags.DEFINE_string(
    "dataset", "/Volumes/Elements/data/coco_dataset/coco/5k.txt", "path to dataset"
)
...
def representative_data_gen():
    ...
    for input_value in range(10):
        if os.path.exists(fimage[input_value]):
            ...
            print(f"calibration image {fimage[input_value]}")
            yield [img_in]
        else:
            continue
